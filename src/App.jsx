          ...
          <table class="table-auto mt-10">
            <thead>
              <tr>
                ...
                <th className="px-3">Rice (gm)</th>
                <th className="px-3">Daal (gm)</th>
                <th className="px-3">Egg (rs)</th>
                <th className="px-3">Masala (rs)</th>
                <th className="px-3">Oil (gm)</th>
                <th className="px-3">Fuel (rs)</th>
                <th className="px-3">Breakfast (rs)</th>
              </tr>
            </thead>
            <tbody>
              <tr>
